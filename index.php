...
<head>
	...
	<title>MO*town - Woningzoeker</title>
...
<div id="container" class="clearfix init animation">
	...
	<div id="viewport" class="clearfix">
		...
		<div id="block-container">
			<ul class="tabbar"><li class="btn color-secondary">Westgevel</li><li class="btn color-secondary">Zuid-Westgevel</li><li class="btn color-secondary">Zuidgevel</li><li class="btn color-secondary">Oostgevel</li></ul>
		...
		<div id="unit-container">
			...
			<div id="unit-info">
				...
				<div class="rows clearfix">
					...
					<div class="row prop"><span class="label">Verdieping</span><span class="unit-level"></span></div>
					<div class="row prop"><span class="label">Woonoppervlakte</span><span class="unit-livingsurface"></span></div>
					<div class="row prop"><span class="label">Inhoud</span><span class="unit-volume"></span></div>
					<div class="row prop"><span class="label">Kamers</span><span class="unit-roomcount"></span></div>
					<div class="row prop"><span class="label">Terras</span><span class="unit-terrace"></span></div>
					<div class="row prop"><span class="label">Ori&euml;ntatie terras</span></span><span class="unit-orientationterrace"></span></div>

					<div class="row prop dummy"><span class="label">&nbsp;</span><span class="unit-dummy">&nbsp;</span></div>
				</div>
				
				<a id="unit-form-btn" href="https://www.nieuwbouw-demaasbode.nl/" class="btn btn-disabled placeholder" target="bpd">Meer info</a>
				<a id="unit-contact-btn" href="https://www.nieuwbouw-motown.nl/service/contact" class="btn btn-disabled color-secondary placeholder" target="bpd">Interesse? Neem contact op!</a>
